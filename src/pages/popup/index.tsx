...
function Popup() {
    ...
    async function getKey() {
        try {
            ...
            if (out.rot_key) setRotKey(out.rot_key as string);
        } catch (e) {
            setRotKey(null);
    ...
    function openWebsite(extensionKeysPage = false) {
        if (!extensionKeysPage)
            ...
            tabs.create({
                url: "https://www.badclients.app/auth/profile/extension_keys",
            });
    }
                        ...
                        <div className="card bg-success/10 border border-success/20">
                            <div className="card-body p-3">
                                ...
                                <p className="text-xs opacity-70">
                                    Your extension key is configured and ready
                                    to use.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="space-y-4">
                        <div className="text-center">
                            ...
                            <p className="text-xs text-base-content/60">
                                Enter your extension key to get started
                            </p>
                        </div>
                        ...
                        <div className="space-y-3">
                            <div className="form-control">
                                <input
                                    ...
                                    value={inputRotKey}
                                    onChange={(ev) =>
                                        setInputRotKey(ev.target.value)
                                    }
                                    disabled={isLoading}
                                    onKeyDown={(ev) =>
                                        ev.key === "Enter" && handleSubmit(ev)
                                    }
                                />
                            </div>
